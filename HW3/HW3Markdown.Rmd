...
ggplot(gas, aes(x = Competitors, y = Price, fill = Competitors)) + 
  ...
  scale_fill_manual(values = c("Y" = "forestgreen", "N" = "dodgerblue")) + 
  theme_minimal()
...
Evidence: At a 95% confidence interval, -0.039 to 0.306
...
ggplot(bootHighway, aes(x = diffmean)) + 
  ...
  labs(title = "Does Direct Highway Access increase Gas Prices? (Boostrapped)",
