...
ggplot(iron) + geom_histogram(aes(x=nflip), binwidth=1) + ggtitle("Sims for. Flagged Trades for Iron Bank") +
...
ggplot(gourmet) + geom_histogram(aes(x=nflip), binwidth=1) + ggtitle("Simulated Health Code Violations for Gourmet Bites") +
...
ggplot(chiSquaredDF) + 
  geom_histogram(bins = 30, aes(x=chiSquared)) + ggtitle("Simulated Chi-Squared Values from Brown Corpus Sentences") +
  xlab("Chi-Squared Value") +
  ylab("Frequency") + 
