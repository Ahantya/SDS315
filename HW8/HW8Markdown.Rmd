...
ggplot(covid, aes(x = days_since_first_death, y = deaths, color = country)) +
  ...
  scale_color_manual(values = c("Italy" = "green", "Spain" = "yellow")) + 
  theme_minimal() 
