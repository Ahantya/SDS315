...
capData2Summary <- summarize(capData2, totalBoardings = sum(boarding), .groups = "keep")


ggplot(capData2Summary) +
  geom_point(aes(x = temperature, y = totalBoardings, color=weekend, group=weekend), size=0.6) +
